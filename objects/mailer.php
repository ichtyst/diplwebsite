...
class Mailer
{
	...
	public function Send(array $to, $title, $message)
	{
		...
		{
			$wrappedmessage = '
<center><div style="text-align:left; font-size:15px; padding:10px; font-family:sans-serif; margin:0 auto; width:500px; max-width:700px; min-width:700px; background:#DBCFC3; background-color:#DBCFC3; border:3px solid #A6886C; -moz-border-radius:15px; border-radius: 15px; color:black;"><p>'.l_t('Hello %s,',$name).'</p>
<p style="color:#222">
'.$message."
</p>

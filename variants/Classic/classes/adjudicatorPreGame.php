...
class ClassicVariant_adjudicatorPreGame extends adjudicatorPreGame {
	...
	protected $countryUnits = array(
		'Grossbritannien' => array(
					'Edingburgh'=>'Fleet', 'Liverpool'=>'Army', 'London'=>'Fleet'
				),
		'Frankreich' => array(
					'Brest'=>'Fleet', 'Paris'=>'Army', 'Marsaille'=>'Army'
				),
		'Italien' => array(
					'Venedig'=>'Army', 'Rom'=>'Army', 'Neapel'=>'Fleet'
				),
		'DeutschesReich' => array(
					'Kiel'=>'Fleet', 'Berlin'=>'Army', 'M&uuml;nchen'=>'Army'
				),
		'OsterreichUngarn' => array(
					'Wien'=>'Army', 'Triest'=>'Fleet', 'Budapest'=>'Army'
				),
		'OsmanischesReich' => array(
					'Smyrna'=>'Army', 'Ankara'=>'Fleet', 'Konstantinopel'=>'Army'
				),
		'Russland' => array(
					'Moskau'=>'Army', 'St. Petersburg (South Coast)'=>'Fleet', 'Warschau'=>'Army', 'Sewastopol'=>'Fleet'
				)
		);

...
$territoryRawData=array(
	array('Anchorage', 'Coast', 'Yes', 0, 290, 270, 140, 125),
	array('Yukon', 'Coast', 'No', 0, 384, 380, 192, 185),
	array('Calgary', 'Land', 'Yes', 0, 530, 616, 265, 309),
	array('Northern BC', 'Land', 'No', 0, 422, 510, 211, 272),
	array('Vancouver', 'Coast', 'Yes', 0, 426, 638, 220, 332),
	array('Abitibi', 'Coast', 'No', 0, 982, 675, 491, 336),
	array('Ungava', 'Coast', 'Yes', 0, 985, 540, 495, 270),
	array('Cote-Nord', 'Coast', 'No', 0, 1065, 595, 536, 295),
	array('Quebec', 'Coast', 'Yes', 0, 1040, 675, 518, 339),
	array('Montreal', 'Coast', 'Yes', 0, 1030, 710, 509, 357),
	array('Beauce', 'Coast', 'No', 0, 1073, 708, 538, 355),
	array('Gaspesie', 'Coast', 'No', 0, 1105, 630, 553, 315),
	array('San Francisco', 'Coast', 'Yes', 0, 360, 880, 180, 442),
	array('Los Angeles', 'Coast', 'Yes', 0, 360, 952, 185, 476),
	array('San Diego', 'Coast', 'Yes', 0, 411, 1009, 210, 500),
	array('Dallas', 'Land', 'Yes', 0, 770, 1040, 385, 520),
	array('Houston', 'Coast', 'Yes', 0, 780, 1090, 397, 546),
	array('San Antonio', 'Coast', 'Yes', 0, 745, 1125, 368, 560),
	array('West Texas', 'Land', 'No', 0, 675, 1065, 337, 533),
	array('Minneapolis', 'Coast', 'Yes', 0, 768, 770, 387, 408),
	array('Iowa', 'Land', 'No', 0, 790, 855, 395, 436),
	array('Indiana', 'Coast', 'No', 0, 910, 875, 455, 435),
	array('Chicago', 'Coast', 'Yes', 0, 868, 899, 436, 452),
	array('Milwaukee', 'Coast', 'Yes', 0, 837, 815, 418, 410),
	array('Milwaukee (North Coast)', 'Coast', 'No', 0, 818, 765, 409, 388),
	array('Milwaukee (East Coast)', 'Coast', 'No', 0, 863, 824, 434, 412),
	array('West Pennsylvania', 'Coast', 'No', 0, 1020, 830, 509, 415),
	array('New York State', 'Coast', 'No', 0, 1045, 782, 520, 392),
	array('New York City', 'Coast', 'Yes', 2, 1090, 788, 544, 393),
	array('New Jersey', 'Coast', 'Yes', 2, 1088, 818, 544, 409),
	array('Philadelphia', 'Land', 'Yes', 0, 1048, 810, 522, 414),
	array('Florida Panhandle', 'Coast', 'No', 0, 978, 1049, 493, 524),
	array('Jacksonville', 'Coast', 'Yes', 0, 1048, 1048, 524, 524),
	array('Miami', 'Coast', 'Yes', 0, 1058, 1088, 528, 545),
	array('Tampa', 'Coast', 'Yes', 0, 1023, 1058, 512, 531),
	array('Havana', 'Coast', 'Yes', 0, 1060, 1165, 538, 580),
	array('Holguin', 'Coast', 'Yes', 0, 1184, 1155, 592, 579),
	array('Kingston', 'Coast', 'Yes', 0, 1194, 1204, 597, 602),
	array('Camaguey', 'Coast', 'No', 0, 1135, 1156, 565, 579),
	array('Camaguey (North Coast)', 'Coast', 'No', 0, 1142, 1144, 571, 572),
	array('Camaguey (South Coast)', 'Coast', 'No', 0, 1142, 1164, 569, 584),
	array('Guadalajara', 'Coast', 'Yes', 0, 625, 1260, 310, 631),
	array('Potosi', 'Coast', 'No', 0, 700, 1220, 344, 608),
	array('Veracruz', 'Coast', 'Yes', 0, 780, 1280, 394, 639),
	array('Mexico', 'Land', 'Yes', 0, 722, 1280, 363, 640),
	array('Guerrero', 'Coast', 'No', 0, 680, 1298, 340, 649),
	array('Oaxaca', 'Coast', 'No', 0, 748, 1320, 375, 660),
	array('Antioquia', 'Coast', 'No', 0, 1280, 1350, 642, 672),
	array('Guajira', 'Coast', 'No', 0, 1306, 1294, 653, 647),
	array('Vichada', 'Land', 'No', 0, 1378, 1360, 689, 682),
	array('Bogota', 'Land', 'Yes', 0, 1364, 1410, 684, 703),
	array('Lima', 'Coast', 'Yes', 0, 1352, 1525, 674, 765),
	array('Ecuador', 'Coast', 'No', 0, 1245, 1520, 628, 760),
	array('Cali', 'Coast', 'Yes', 0, 1280, 1420, 640, 710),
	array('Cali (North Coast)', 'Coast', 'No', 0, 1256, 1358, 628, 679),
	array('Cali (South Coast)', 'Coast', 'No', 0, 1270, 1420, 635, 710),
	...
	array('Kansas', 'Coast', 'Yes', 0, 750, 925, 380, 462),
	array('Nebraska', 'Coast', 'No', 0, 725, 885, 352, 447),
	array('Dakotas', 'Coast', 'No', 0, 696, 805, 348, 405),
	...
	array('Ohio', 'Coast', 'Yes', 2, 962, 855, 482, 436),
	...
	array('Greenland', 'Coast', 'Yes', 0, 1084, 194, 538, 95),
	...
	array('North Pacific Ocean', 'Sea', 'No', 0, 120, 840, 63, 425),
	...
	array('Nicaragua (West Coast)', 'Coast', 'No', 0, 1020, 1360, 509, 681),
	...
	array('Iowa (Missouri Coast)', 'Coast', 'No', 0, 759, 864, 383, 437),
	array('Iowa (Mississippi Coast)', 'Coast', 'No', 0, 817, 847, 408, 433),
	array('Milwaukee (Mississippi Coast)', 'Coast', 'No', 0, 825, 819, 408, 407)
);
